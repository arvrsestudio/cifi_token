...
contract Cifi_Token is ERC20,AccessControl,ERC20Burnable,Pausable{contract Cifi_Token is ERC20,AccessControl,ERC20Burnable,Pausable{
  ...
  function burn(uint256 amount) whenNotPaused() public validMultiSignWallet override virtual {
    ...
    function mint(address account, uint256 amount) whenNotPaused() validMultiSignWallet public virtual {
